...
class DataViewsClient(BaseClient):
    ...
    def __init__(self, api_key, webserver_host="https://citrination.com", suppress_warnings=False, proxies=None):
        members = ["create", "update", "delete", "get", "check_predict_status", "predict", "get_predict_result"]
    ...
    def get_ml_configuration_status(self, job_id):
        """
    ...
    def predict(self, data_view_id, prediction_source, use_prior, candidates):
        """
